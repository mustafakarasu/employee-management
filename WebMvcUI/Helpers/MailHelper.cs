...
namespace WebMvcUI.Helpers
{
    public static class MailHelper
    {
        ...
        public static bool SendMail(User user, Company company, IConfiguration configuration)
        {
        ...
        public static bool CompanyMail(Company company, User user, IConfiguration configuration)
        {
            string subject = "Hesap Oluşturuldu";
            string title = "";
            ...
            companyMsj.From = new MailAddress(fromEmail, "Murettebat İnsan Kaynakları", Encoding.UTF8);
            companyMsj.Subject = subject;
            companyMsj.SubjectEncoding = Encoding.UTF8;

            companyMsj.AlternateViews.Add(GetHtml(Environment.CurrentDirectory + "\\wwwroot\\Images\\MailImage\\WebMvcUI.png", companyMessage, "HOŞGELDİNİZ"));
        ...
        public static bool UserLimitNoticeMail(User user, Company company, IConfiguration configuration)
        {
            ...
            companyMsj.AlternateViews.Add(GetHtml(Environment.CurrentDirectory + "\\wwwroot\\Images\\MailImage\\WebMvcUI.png", companyMessage, "Limit Bildirimi"));
        ...
        public static bool EndDateNoticeMail(User user, Company company, IConfiguration configuration)
        {
            ...
            companyMsj.AlternateViews.Add(GetHtml(Environment.CurrentDirectory + "\\wwwroot\\Images\\MailImage\\WebMvcUI.png", companyMessage, "Paket Bildirimi"));
