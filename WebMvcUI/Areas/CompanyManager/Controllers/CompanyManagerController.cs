...
namespace WebMvcUI.Areas.CompanyManager.Controllers
{
    ...
    public class CompanyManagerController : Controller
    {
        ...
        public CompanyManagerController(IEntityRepository<User> userRepository, IEntityRepository<Company> companyRepository, IEntityRepository<Idea> ideaRepository, IHostingEnvironment IHostingEnvironment, IEntityRepository<Role> roleRepository, IConfiguration configuration)
        {
        ...
        public IActionResult AddEmploee(User user, IFormFile ImageURL)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MailHelper.SendMail(user, company,_configuration);
                ...
                if (companyUsers.Count == userLimit)
                    MailHelper.UserLimitNoticeMail(GetLoginUser(), company,_configuration);
